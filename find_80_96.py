...
filtered_data = grid_totals[(grid_totals['x'] == 80) & (grid_totals['y'] == 96)]
...
plt.title('Total User Count for Grid (80, 96) over Time')
...
plt.title('Daily Average User Count for Grid (80, 96)')
plt.xlabel('Day (d)')
